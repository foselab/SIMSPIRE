...
If you want to run your simspire.web.app locally in the production mode, run `mvn jetty:run -Pproduction`.
...
- Under the `srs/main/java` are located Application sources
    ...
    - `MainView.java` is an example Vaadin simspire.web.view
...
- Search UI circuitsimulator.components and their usage examples at [vaadin.com/circuitsimulator.components](https://vaadin.com/circuitsimulator.components).
