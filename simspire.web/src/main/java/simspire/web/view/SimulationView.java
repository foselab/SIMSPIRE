...
import simspire.web.charts.RightVerticalLayout;
import simspire.web.data.CircuitComponents;
import simspire.web.data.DemographicComponents;

/**
 * Manages the simulation simspire.web.data that has to be shown
 */
public class SimulationView extends Composite<HorizontalLayout> implements HasComponents {
	...
	/**
	 * Section where circuit circuitsimulator.components are displayed
	 */
	...
	/**
	 * Builds the simulation simspire.web.view
	 */
	public SimulationView() {
		...
		final H4 demoTitle = new H4("Demographic simspire.web.data");
