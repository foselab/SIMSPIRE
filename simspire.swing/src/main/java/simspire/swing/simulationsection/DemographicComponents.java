...
import simspire.swing.utils.GraphicConstants;

/**
 * Manages demographic circuitsimulator.components
 */
public class DemographicComponents {

	/**
	 * Demographic circuitsimulator.components constructor
	 * 
	 * @param lungSimulator backend access
	 * @param yInitPar      initial coordinate for circuitsimulator.components allocation
	 * @param leftPanel     panel where circuitsimulator.components have to be added
	 */
